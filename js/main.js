...
$('.back-nav').on('click', function(){
	...
	if (counter == 0) {
		...
		$('.navigation-list-1, .navigation-list-2').addClass('d-none').removeClass('d-block');
		$('.navigation-list-0').addClass('d-flex').removeClass('d-none');
	} else if (counter == 1) {
		
		$('.navigation-list-0, .navigation-list-2').addClass('d-none').removeClass('d-block');
		$('.navigation-list-1').addClass('d-block').removeClass('d-none');
	}
})
 ...
 if(document.querySelector('.custom-select-wrapper')){
	...
	for (const option of document.querySelectorAll(".custom-option")) {
		...
		option.addEventListener('click', function() {
			...
			for (const option1 of document.querySelectorAll(".custom-option")) {
